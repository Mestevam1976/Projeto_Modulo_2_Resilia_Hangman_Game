...
def multiplayer(): #função multiplayer com escolha entre jogar com 2 ou 3.

    correto = False  
    while correto == False:

        num_jogadores = input(
            'Deseja jogar com 2 ou 3 jogadores?  ')
        ...
        if num_jogadores == '2':
            ...
            print('Favor digitar somente 2 ou 3!!!')
            correto = False
...
def numero_jogadores():  # Função que estabelece a quantidade de jogadores (singleplayer ou multiplayer)
    ...
    while correto == False:
        num_jogadores = input(
            'Olá! Por gentileza, por favor informe se deseja jogo individual (I) ou multiplayer (M):  '.upper())
        if num_jogadores == 'i':
        ...
        elif num_jogadores == 'm':
            print (multiplayer()) 
            correto = True
                     
        else:
            print('Favor digitar somente jogo individual (I) ou multiplayer (M)!')
            correto = False
