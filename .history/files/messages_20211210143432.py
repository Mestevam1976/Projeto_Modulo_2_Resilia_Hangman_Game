...
'deep learning' : 'DICA: É uma técnica que se enquadra na disciplina de aprendizado de máquina. É baseado em redes neurais artificiais'
 inspiradas na estrutura do cérebro humano. Ele aprende com grandes quantidades de dados e é particularmente bom em encontrar padrões de dados não estruturados, como texto e imagens.'
