...
'data science' : 'DICA: É a disciplina de aplicação de técnicas analíticas avançadas para extrair informações valiosas de dados para a'
 tomada de decisões de negócios e planejamento estratégico. Ele reúne campos como mineração de dados, estatística, matemática, aprendizado de máquina, visualização de dados e programação de software.'
