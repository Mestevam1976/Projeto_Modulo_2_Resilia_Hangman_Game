...
'business intelligence' :'DICA: É a disciplina de analisar e transformar dados para extrair valiosos insights de negócios para permitir' a tomada de decisões. Hoje, o BI é normalmente usado para se referir a análises descritivas e relatórios.' 
