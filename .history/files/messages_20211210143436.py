...
'\Ninspiradas na estrutura do cérebro humano. Ele aprende com grandes quantidades de dados e é particularmente bom em encontrar padrões de dados não estruturados, como texto e imagens.'
