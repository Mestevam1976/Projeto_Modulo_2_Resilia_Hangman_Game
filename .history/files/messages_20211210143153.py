...
'artificial intelligence' : 'DICA: Refere-se à capacidade de uma máquina de imitar as capacidades da mente humana, como aprender com exemplos e experiências, reconhecer objetos, compreender e responder à linguagem, tomar decisões e resolver problemas.'
