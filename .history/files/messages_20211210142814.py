...
'data mining' : 'DICA: É um processo de extração e descoberta de padrões em grandes conjuntos de dados envolvendo métodos na interseção'
 de aprendizado de máquina, estatísticas e sistemas de banco de dados. Este termo foi cunhado por volta de 1990 e rapidamente se tornou uma palavra da moda.'
