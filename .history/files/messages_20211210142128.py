...
tech_dificeis = {
    'engenharia de dados': 'DICA: É a disciplina focada nos apectos como a identificação das fontes de dados, coletânea, na curadoriaprocessador', 'enfileiramento', 'modularizacao'
}
