...
def escolha_tema():  # Função para selecionar o tema específico, localizado no arquivo messages.py
    ...
    while opcao_tema == False:  # condição que mantém o loop em funcionamento, logo, o loop cessa quando True
        ...
        escolhe_tema = input('''
Escolha abaixo tema de sua preferência:
...
def imprime_mensagem_vencedor():
    print(formatting.escolher_cor('grenn"Parabéns, você ganhou!")
...
def desenha_forca(erros):
    ...
    if (erros == 7):
        print(formatting.escolher_cor('red', images.forca[7]))
    ...
    while (not acertou and not enforcou):
        ...
        if (chute in palavra_secreta):
            ...
            if (letras_faltando == "0"):
                print("PARABÉNS!! Você encontrou todas as letras formando a palavra '{}'".format(
